							...
							<div class="slider-col">
								<div class="product-custom" data-aos="fade-down" data-aos-duration="1000">
									<div class="profile-widget">
										<div class="doc-img">
											<a href="medicine-details.html" class="property-img">
										...
										<div class="pro-content">
											...
											<h3 class="title">
												<a href="medicine-details.html">Medicine Name</a>
											</h3>
											...
											<ul class="property-category d-flex justify-content-between">
												...
												<li>
													...
													<span class="category-value date">Tablets</span>
												</li>
											</ul>
										</div>
									</div>
									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<h3 class="title">
													<a href="medicine-details.html">Beautiful Condo Room</a> 
												</h3>
												...
												<ul class="property-category d-flex justify-content-between align-items-center">
													<li class="user-info">
														<a href="medicine-details.html"><img src="assets/img/profiles/avatar-01.jpg" class="img-fluid avatar" alt="User"></a>
														<div class="user-name">
															<h6><a href="medicine-details.html">Marc Silva</a></h6>
															<p>Newyork</p>
														</div>													
													</li>
													<li>
														<a href="medicine-details.html" class="btn-primary">Book Now</a>
													</li>
												</ul>
											</div>
										</div>		
									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<h3 class="title">
													<a href="medicine-details.html">Grand Mahaka</a> 
												</h3>
												...
												<ul class="property-category d-flex justify-content-between align-items-center">
													<li class="user-info">
														...
														<div class="user-name">
															<h6><a href="medicine-details.html">Karen Maria</a></h6>
															<p>South Dokata</p>
														</div>													
													</li>
													<li>
									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<h3 class="title">
													<a href="medicine-details.html">Royal Apartment</a> 
												</h3>
												...
												<ul class="property-category d-flex justify-content-between align-items-center">
													<li class="user-info">
														<a href="medicine-details.html"><img src="assets/img/profiles/avatar-03.jpg" class="img-fluid avatar" alt="User"></a>
														<div class="user-name">
															<h6><a href="medicine-details.html">Scott Gwin</a></h6>
															<p>Minipoliies</p>
														</div>													
													</li>
													<li>
									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<h3 class="title">
													<a href="medicine-details.html">Lunaria Residence</a> 
												</h3>
												...
												<ul class="property-category d-flex justify-content-between align-items-center">
													<li class="user-info">
														<a href="medicine-details.html"><img src="assets/img/profiles/avatar-04.jpg" class="img-fluid avatar" alt="User"></a>
														<div class="user-name">
															<h6><a href="medicine-details.html">Burdette</a></h6>
															<p>Cambridge</p>
														</div>													
													</li>
													<li>
									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<h3 class="title">
													<a href="medicine-details.html">Grand Villa house</a> 
												</h3>
												<p><i class="feather-map-pin"></i> 470 Park Ave S, New York, NY 10016</p>
												<ul class="d-flex details">
													<li>
												...
												<ul class="property-category d-flex justify-content-between align-items-center">
													<li class="user-info">
														<a href="medicine-details.html"><img src="assets/img/profiles/avatar-05.jpg" class="img-fluid avatar" alt="User"></a>
														<div class="user-name">
															<h6><a href="medicine-details.html">Kell Robinson</a></h6>
															<p>USA</p>
														</div>													
													</li>
													<li>
									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<h3 class="title">
													<a href="medicine-details.html">Stephen Alexander Homes</a> 
												</h3>
												...
												<ul class="property-category d-flex justify-content-between align-items-center">
													<li class="user-info">
														<a href="medicine-details.html"><img src="assets/img/profiles/avatar-07.jpg" class="img-fluid avatar" alt="User"></a>
														<div class="user-name">
															<h6><a href="medicine-details.html">Pittman</a></h6>
															<p>Cambridge</p>
														</div>													
													</li>
													<li>
									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<h3 class="title">
													<a href="medicine-details.html">Minimalist and bright flat</a> 
												</h3>
												<p><i class="feather-map-pin"></i> 518-520 8th Ave, New York, NY 10018, USA</p>
												<ul class="d-flex details">
													<li>
												...
												<ul class="property-category d-flex justify-content-between align-items-center">
													<li class="user-info">
														<a href="medicine-details.html"><img src="assets/img/profiles/avatar-10.jpg" class="img-fluid avatar" alt="User"></a>
														<div class="user-name">
															<h6><a href="medicine-details.html">John Doe</a></h6>
															<p>Newyork</p>
														</div>													
													</li>
													<li>
									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<h3 class="title">
													<a href="medicine-details.html">Place perfect for nature</a> 
												</h3>
												<p><i class="feather-map-pin"></i> 318-S Oakley Blvd, Chicago, IL 60612, USA</p>
												<ul class="d-flex details">
													<li>
												...
												<ul class="property-category d-flex justify-content-between align-items-center">
													<li class="user-info">
														<a href="medicine-details.html"><img src="assets/img/profiles/avatar-12.jpg" class="img-fluid avatar" alt="User"></a>
														<div class="user-name">
															<h6><a href="medicine-details.html">Richard</a></h6>
															<p>Newyork</p>
														</div>													
													</li>
													<li>
